...
public class PkiHelper {
	...
	public static String[] algName = { "SHA1withRSA", "SHA224withRSA", "SHA256withRSA", "SHA384withRSA",
			"SHA512withRSA" };
	...
	public static PrivateKey loadPrivFromP12(String certFilePath, String passwd) throws Exception {
		PrivateKey pk = null;
	...
	public static byte[] sign(int alg, PrivateKey pk, byte[] data) throws Exception {
	...
	public static boolean verify(int alg, X509Certificate cert, byte[] data, byte[] sigToVerify) throws Exception {
	...
	public static X509Certificate loadCertFromP12(String certFilePath, String passwd) throws KeyStoreException,
			IOException, NoSuchAlgorithmException, CertificateException, FileNotFoundException {
